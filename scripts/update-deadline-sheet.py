...
CATEGORIES = [
    ...
    (2,  '바람막이+아노락',      'A 시즌메인', '10/7',   date(2026, 10, 7)),   # 2026-07-24 순연 후 청자켓과 정점 스왑
    (3,  '청자켓·데님자켓',      'A 시즌메인', '10/12',  date(2026, 10, 12)),  # 2026-07-24 바람막이와 정점 스왑
    (4,  '마운틴파카 (60/40)',   'A 시즌메인', '10/26',  date(2026, 10, 26)),  # 2026-07-16 정점 9/28→10/26 조정
    (5,  '맨투맨·후드티',        'C 메인추가', '10/26',  date(2026, 10, 26)),
    (6,  '필드·헌팅자켓',        'C 메인추가', '환절기',  None),
