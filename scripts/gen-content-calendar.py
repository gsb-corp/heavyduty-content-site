...
CATEGORIES = [
    ...
    (2,  '바람막이+아노락',      date(2026, 9, 21),  '10/12',  'A 시즌메인', '정점 -3주 (P-3 표준)', date(2026, 10, 12)),  # 2026-07-24 정점 10/1→10/12 순연 (발주 지연, 7/27 발주 기준)
    (3,  '청자켓·데님자켓',      date(2026, 9, 28),  '10/7',   'A 시즌메인', '정점 -1주 (바람막이와 어긋남)', date(2026, 10, 7)),
    (4,  '마운틴파카 (60/40)',   date(2026, 10, 5),  '10/26',  'A 시즌메인', '데이터랩 3년 평균(11월 4주) 절충 · 정점 -3주 (어긋남)', date(2026, 10, 26)),  # 2026-07-16 정점 9/28→10/26 조정
    (5,  '맨투맨·후드티',        date(2026, 10, 12), '10/26',  'C 메인추가', '🥇 정점 -2주', date(2026, 10, 26)),
    (6,  '필드·헌팅자켓',        date(2026, 10, 19), '환절기',  'C 메인추가', '🥈 가을 환절기 자유 배치 (10월 3주)', None),
