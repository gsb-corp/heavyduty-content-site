...
CATEGORIES = [
    ...
    (2,  '바람막이+아노락',      date(2026, 9, 21),  '10/7',   'A 시즌메인', '정점 -2주 (7/24 청자켓과 정점 스왑)', date(2026, 10, 7)),  # 2026-07-24 순연 후 청자켓과 스왑
    (3,  '청자켓·데님자켓',      date(2026, 9, 28),  '10/12',  'A 시즌메인', '정점 -2주 (7/24 바람막이와 정점 스왑)', date(2026, 10, 12)),
